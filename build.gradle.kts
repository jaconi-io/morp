...
dependencies {
    implementation(platform("org.springframework.cloud:spring-cloud-gateway-dependencies:5.0.2"))
    ...
    testImplementation("org.mock-server:mockserver-junit-jupiter:8.0.0")
