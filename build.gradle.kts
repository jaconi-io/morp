...
dependencies {
    implementation(platform("org.springframework.cloud:spring-cloud-gateway-dependencies:5.0.0-RC1"))
    ...
    suites {
        ...
        val integrationTest by registering(JvmTestSuite::class) {
            ...
            dependencies {
                ...
                implementation("com.github.dasniko:testcontainers-keycloak:4.0.0")
...
tasks.withType<BootBuildImage> {
    ...
    // Obscure UnsatisfiedLinkError in Docker Image with the default runImage
